...
import { ecMulGenerator, transientHash } from '@midnight-ntwrk/midnight-js-protocol/compact-runtime';
...
export function issueDemoCredential(subjectHash, profile = 'eligible') {
  ...
  const message = [credential.age, credential.jurisdiction, credential.householdSize, credential.annualIncome, transientHash(credential.credentialId), BigInt(subjectHash)];
